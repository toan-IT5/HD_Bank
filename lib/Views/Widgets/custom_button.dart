...
class CustomButton {
  ...
  static Widget small(
      {required VoidCallback onTap, required String content, Color? color}) {
  ...
  static Widget lightBlue(
    ...
    Widget loading = SizedBox(
      ...
      child: CircularProgressIndicator(
          strokeWidth: 2.5, color: strokeColor ?? Colors.white),
    );
    Widget button = Container(
        height: 48,
        alignment: Alignment.center,
    ...
    return GestureDetector(
        ...
        child: Container(
            ...
            decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(8.0),
                border: Border.all(color: BaseColor.orange, width: 0.5),
                boxShadow: [
                  if (isShadow)
                    BoxShadow(
                        color: const Color(0xff003399).withOpacity(0.2),
            ...
            child: Row(
              ...
              children: [
                Text(content,
                    style: BaseTextStyle.button(color: BaseColor.orange)),
                SizedBox(
                  height: 16,
                  child: Image.asset(
                    "assets/icons/directions/orange_next_light.png",
                    fit: BoxFit.fitHeight,
                  ),
                ),
              ],
  ...
  static Widget lightBlueWithIcon(
      {required Function() onTap,
      required String content,
      String? imgPath,
      TextStyle? style,
    ...
    Widget row = Row(
      ...
      children: [
        ...
        Text(
          content,
          style: style ?? BaseTextStyle.button(color: BaseColor.blue),
          maxLines: 2,
          overflow: TextOverflow.ellipsis,
        ),
      ],
